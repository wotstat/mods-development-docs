...
HTML-страницы объявляют Markdown через `rel="alternate"`, поэтому агент может начать с обычной ссылки на документацию и автоматически перейти к чистому тексту.