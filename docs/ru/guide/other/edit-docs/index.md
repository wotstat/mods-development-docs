...
:::
4. После внесения изменений, в верхнем правом углу нажмите на кнопку `Commit changes`.
5. В открывшемся окне введите краткое описание ваших изменений.
::: details Пример окна коммита
![commit-changes](./assets/web-commit-changes.png){width=400}
:::

::: tip TODO
Дописать что там дальше с PR и скриншотом, но это надо делать не с основного аккаунта
:::
