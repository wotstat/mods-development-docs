...
Кроме того, если во время боя игрок изменит разрешение экрана, то наш прямоугольник и текст останутся на старых координатах. Чтобы этого избежать, нужно подписаться на событие изменения размера окна и обновлять позицию.
...
Кроме того, нужно объявить метод, который будет вызываться из Python кода для обновления текста и его цвета.
