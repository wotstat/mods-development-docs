# Автоматизация сборки модов {#mod-automatization}
...
## Создание репозитория системы контроля версий {#create-repo}
...
### Связывание локального проекта с репозиторием {#link-repo}
...
### Отправка первого коммита {#first-commit}
...
## Настройка автоматической сборки {#setup-cicd}
...
### Если у вас есть `AS3` часть {#as3-part}
...
### Отправка изменений в репозиторий {#push-changes}
...
#### Проверка `Actions` {#check-actions}
...
#### Информация о релизе {#release-info}
...
#### Редактирование релиза {#edit-release}
