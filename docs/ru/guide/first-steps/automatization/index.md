...
В качестве хранилища исходного кода можно использовать любой из популярных сервисов, однако наиболее распространённым является [GitHub](https://github.com/). На его примере рассмотрим процесс автоматизации сборки.
